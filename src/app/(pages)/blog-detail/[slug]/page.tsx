        ...
        <div className='mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:space-y-16 lg:px-8'>
          <div className='gap-16 md:grid md:grid-cols-5 lg:grid-cols-7'>
            ...
            <div className='space-y-12 md:col-span-3 lg:col-span-5'>
              ...
              <article id='content' className='space-y-12 post-bg p-4 rounded-[8px]'>
                <h1 className='text-foreground text-4xl font-semibold mb-0.5'>{post.title}</h1>
                <p className='text-muted-foreground text-xl mb-2 mt-0.5'>{post.description}</p>
                <div>
